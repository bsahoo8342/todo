...
function saveTasks() {
    try {
        ...
        // Also save to a downloadable JSON file format
        // This demonstrates the JSON storage concept
        console.log('Tasks saved to localStorage as JSON:', tasksJSON);
    } catch (error) {
...
function loadTasks() {
    try {
        ...
        if (tasksJSON) {
            ...
            console.log('Tasks loaded from JSON:', tasks);
        }
    } catch (error) {
...
// Optional: Export tasks to a JSON file
...
// Optional: Import tasks from a JSON file
...
// ========================================
// You can add buttons in HTML to trigger these functions
